...
/**
 * @link https://github.com/LeinneSW/PureEntities
 */
...
abstract class LivingBase extends Living{
	...
	abstract public function getDefaultNavigator() : EntityNavigator;
	...
	protected function initEntity(CompoundTag $nbt) : void{
		...
		if($nbt->getTag("HealF") instanceof FloatTag){
			...
			($healthTag = $nbt->getTag("Health")) instanceof FloatTag ||
			$healthTag instanceof IntTag
		){
